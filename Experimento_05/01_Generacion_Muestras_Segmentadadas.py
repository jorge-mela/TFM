...
PATH_RESULT = "./Experimento_05/data/"

D = 80  # Doble del tamaño de ventana deseado
...
def calcula_features(
    ...
    xwin, ywin = np.meshgrid(np.arange(0, vx.shape[0]*dxx, dxx), np.arange(0, vx.shape[1]*dxy, dxy))

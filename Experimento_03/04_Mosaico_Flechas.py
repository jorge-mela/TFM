...
inputs = obtener_dataset("./Experimento_03/data/01_muestras.hdf5", "muestras")[...,0]
campoXY = np.meshgrid(np.arange(0, 320, 4), np.arange(0, 320, 4)) # obtener_dataset(PATH_FLECHAS, "campoXY")
